...
export default function HorizontalSlideshow() {
  ...
  return (
    ...
    >
          ...
          >
            <div className="content">
              <h2>
                ...
                {i === index && <span className="cursor">|</span>}
              </h2>
              <p>{s.author}</p>
            </div>
          </div>
      ...
      {/* PREVIOUS */}
      <button className="nav left" onClick={prev} aria-label="Previous slide">
        ‹
      </button>

      {/* NEXT */}
      <button className="nav right" onClick={next} aria-label="Next slide">
        ›
      </button>
    </section>
  );
